'''
Metto 81 gettoni, ognuno con un 3 su un lato e un 4 sull'altro lato.
Aggiungo 9 gettoni con un 3 da una parte e un 2 dall'altra.
E infine aggiungo ancora un gettone con un 2 da una parte e 
l dall'altra. Méscolali. 
Tu estrarrai a caso un gettone dall'urna e, senza guardarlo, 
lo getterai in aria; poi guarderai il Iato rivolto verso l'alto e dovrai 
indovinare il numero che si trova dall'altra parte. 
Se indovini giusto, sei libero, se sbagli sarai messo a morte; ma puoi rifiutare d'indovinare; in questo caso resti in prigione, senza pericolo per la tua vita. 
