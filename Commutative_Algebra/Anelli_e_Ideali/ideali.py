'''
Gli ideali e gli anelli quozienti sono concetti fondamentali dell'algebra che possono essere compresi attraverso un esempio. Consideriamo l'anello degli interi Z e l'ideale I = 2Z, che rappresenta tutti i multipli di 2. 
...
- **Anello Quoziente**: Costruiamo l'anello quoziente Z/2Z, che consiste nei resti della divisione per 2. Quindi, Z/2Z = {0 + 2Z, 1 + 2Z}. Questo anello ha due elementi: il resto 0 e il resto 1.
'''
