'''
questo esempio, utilizzeremo la crittografia a chiave pubblica basata su Ring-LWE (Learning With Errors su anelli), una costruzione comune in crittografia moderna.
